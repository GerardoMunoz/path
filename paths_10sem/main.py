    ...
    def canvas_to_svg(canvas):
        ...
        for item in canvas.find_all():
            ...
            if item_type == "rectangle":
                ...
                fill = canvas.itemcget(item, "fill")
                font_size = 16#int(font.split()[-1] if isinstance(font, str) else font[1])
    ...
    def save_to_html_file(self, filename):
        ...
        <head>
            ...
            <title>Malla</title>
             <style>
                svg text {
                    fill: #000000; /* Change this to the color you want */
                }
            </style>
       </head>
"""+f"""
...
area_colors = {
        ...
        "Humanidades": "#b66",#"#500",
        #"Segunda Lengua": "#080",
        "Electivas Extrínsecas": "#aa6",#"#440",
        "Matemáticas": "#6a6",#"#040",
        "Física": "#9a8",#"#342",
        "Programación": "#6ac",#"#046",
        "Potencia Y Circuitos": "#68a",#"#024",
        "Electrónica": "#6aa",#"#044",
        "Digitales": "#8ac",#"#446",
        "DSP": "#555",#"#000",
        "Automática": "#8cc",#"#266",
        "Telecomunicaciones": "#acc",#"#466",
        "Telemática": "#bcb",#"#565",
        "Bioingeniería": "#cce",#"#668",
        "Proyectos": "#a86",#"#420",
        "Idiomas": "#ca6",#"#640",
        "Electiva": "#aa6",#"#440" ,
        "": "#ac6",#"#460" ,
...
def draw_rectangles(csv_file_path, prereq_file_path):
    ...
    def white_theme():
        global color_path,color_bg,color_pad
        color_path="#000"#Path 122,196,113
        color_bg="#fff"#PCB 18,92,61
        color_pad="#000"
        color_block="#ccc"
        canvas.configure(bg=color_bg)
    ...
    file_name_entry.insert(0, "prerequisitos")  # Default file name without extension
...
#     zoom_entry.configure(state='readonly')  # Set back to readonly
    ...
    # White Theme
    convert_button = tk.Button(control_frame, text="White Theme", command=white_theme)
    convert_button.pack(side=tk.LEFT, padx=10, pady=10)
...
# File paths
csv_file_path = 'curriculum.csv'
prereq_file_path = 'prerequisitos.csv'
